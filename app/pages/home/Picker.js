...
class ThirdPicker extends Component {
  ...
  _onPickerConfirm=(data)=>{
    if (this.state.index == 0) {
      ...
      var str = ArrayUtils.getRemarkWithDate({year: year}, DATE_ENUM.YEAR);
      ...
      var str = ArrayUtils.getRemarkWithDate({year: year, month: month, day: day}, DATE_ENUM.DAY);
      this.props.onPickerConfirm(str, data);
    }
    else if (this.state.index == 3) {
      var year = parseInt(data[0]);
      var month = parseInt(data[1]);
      var str = ArrayUtils.getRemarkWithDate({year: year, month: month}, DATE_ENUM.MONTH);
      this.props.onPickerConfirm(str, data);
    }
    this.hide();
