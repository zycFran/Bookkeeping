...
class Chart extends PureComponent {
    ...
    leftTab = () => {
        ...
        for (let i = 0; i < t.length; t++) {
            tabs.push(
                ...
                >
                    <View key={i}>
                        <Text style={[...t[i].textStyle, { color: this.currentTypeSelect == i ? StreamColor : TitleColor }]} >支出</Text>
                    </View>
                </TouchableHighlight>
            )
        }
    ...
    rightTab = () => {
        ...
        for (let i = 0; i < t.length; t++) {
            tabs.push(
                <TouchableHighlight key={i}
                    style={[...t[i].style, { backgroundColor: this.state.currentTimeSelect == t[i].label ? StreamColor : TitleColor }]}
