        ...
        return (
            <View style={ChartStyles.page}>
                ...
                <View style={ChartStyles.body}>
                    <Text style={styles.name}>总{this.state.currentTypeSelect == 0 ? '支出' : '收入'}: 34555</Text>
                        <Text style={styles.detail}>平均值: 1213</Text>
                        {/* <Svg
                            width={ScreenWidth + ""}
                            height={"100"}
                            fill={'#000'}
                        ...
                        <Text style={styles.inEx}>{this.state.currentTypeSelect == 0 ? '支出' : '收入'}排行榜</Text>
                </View>
            </View>
        )
    }
