        ...
        for (let i = 0; i < t.length; t++) {
            tabs.push(
                <TouchableHighlight key = {i}
                    ...
                    underlayColor={'#28282844'}
                >
                    <View style={[...t[i].style,{ backgroundColor: this.currentTimeSelect == i ? StreamColor : TitleColor }]}>
                        <Text style={[...t[i].style,{ color: this.currentTimeSelect == i ? StreamColor : TitleColor }]} >{t[i].label}</Text>
                    </View>
                </TouchableHighlight>
            )
        }
