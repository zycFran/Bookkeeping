    ...
    leftTab = () => {
        ...
        for (let i = 0; i < t.length; t++) {
            tabs.push(
                ...
                >
                    <View style={[...t[i].style,{ backgroundColor: this.currentSelect == 0 ? StreamColor : StreamColor }]}>
                        <Text style={[...t[i].style,{ color: this.currentSelect == 1 ? TitleColor : StreamColor }]} >{t[i].label}</Text>
                    </View>
                </TouchableHighlight>
            )
        }
