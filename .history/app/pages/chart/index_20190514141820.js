    ...
    leftTab = () => {
        ...
        for (let i = 0; i < t.length; t++) {
            tabs.push(
                ...
                >
                    <View style={[...t[i].style,{ backgroundColor: this.currentSelect == i ? StreamColor : TitleColor }]}>
                        <Text style={[...t[i].style,{ color: this.currentSelect == i ? StreamColor : TitleColor }]} >{t[i].label}</Text>
                    </View>
                </TouchableHighlight>
            )
        }
        ...
        for (let i = 0; i < t.length; t++) {
            tabs.push(
                <TouchableHighlight key = {i}
                    ...
                    underlayColor={'#28282844'}
                >
                    <View style={[...t[i].style,{ backgroundColor: this.currentSelect == 0 ? StreamColor : TitleColor }]}>
                        <Text style={[...t[i].style,{ color: this.currentSelect == 1 ? StreamColor : TitleColor }]} >{t[i].label}</Text>
                    </View>
                </TouchableHighlight>
            )
        }
